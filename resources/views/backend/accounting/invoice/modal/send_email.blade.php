<form action="{{ url('invoices/send_email') }}" class="validate" method="post">
	{{ csrf_field() }}
	<div class="col-md-12">
	...
	<div class="col-md-12">
	  <div class="form-group">
		<label class="control-label">{{ _lang('Client Invoice Link') }} (<a href="javascript: void(0);" id="copy_invoice_link">{{ _lang('Click to Copy') }}</a>)</label>						
		<input type="text" class="form-control" id="invoice_link" value="{{ url('client/view_invoice/'.md5($invoice->id)) }}" readOnly="true">
	  </div>
	</div>
