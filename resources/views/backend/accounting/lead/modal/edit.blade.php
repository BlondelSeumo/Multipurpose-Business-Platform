...
<form method="post" class="ajax-submit" autocomplete="off" action="{{ action('LeadController@update', $id) }}" enctype="multipart/form-data">
	{{ csrf_field()}}
	...
	<div class="row">
		...
		<div class="col-md-6">
		    <div class="form-group">
			    ...
			    <select class="form-control select2 auto-select" name="country" data-selected="{{ $lead->country }}">
	                <option value="">{{ _lang('Select One') }}</option>
		...
		<div class="col-md-6">
		    <div class="form-group">
			    ...
			    <select class="form-control select2 auto-select" data-selected="{{ $lead->currency }}" name="currency" required>
	                <option value="">{{ _lang('Select One') }}</option>
					{{ get_currency_list() }}
			    </select>
		    </div>
