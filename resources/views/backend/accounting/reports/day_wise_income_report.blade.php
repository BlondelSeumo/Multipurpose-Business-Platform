...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			<span class="panel-title d-none">{{ _lang('Detail Income Report') }}</span>
			
			<div class="card-body">
			
				<div class="report-params">
					<form class="validate" method="post" action="{{ url('reports/day_wise_income/view') }}">
						<div class="row">
              				{{ csrf_field() }}
							<div class="col-md-3">
				...
				<div class="report-header">
				   <h4>{{ isset($account) ? _lang('Detail Income Report Of').' '.$acc->account_title : _lang('Detail Income Report') }}</h4>
