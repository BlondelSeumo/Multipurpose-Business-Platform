...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			<span class="d-none panel-title">{{ _lang('Date Wise Expense Report') }}</span>
			
			<div class="card-body">
			
				<div class="report-params">
					<form class="validate" method="post" action="{{ url('reports/date_wise_expense/view') }}">
						<div class="row">
              				{{ csrf_field() }}
				...
				<div class="report-header">
				   <h4>{{ isset($account) ? _lang('Date Wise Expense Report Of').' '.$acc->account_title : _lang('Date Wise Expense Report') }}</h4>
